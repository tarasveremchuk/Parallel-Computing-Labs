      ...
      <div className="auth-sidebar">
          ...
          <div className="sidebar-features">
            <div className="sidebar-feature">
              ...
              <div className="feature-info">
                ...
                <span className="feature-desc">Admin, Operator, Viewer levels</span>
              </div>
            </div>
            <div className="sidebar-feature">
              <span className="feature-dot blue" />
              <div className="feature-info">
                <span className="feature-title">Device ownership</span>
                <span className="feature-desc">Share access with your team</span>
              </div>
            </div>
            <div className="sidebar-feature">
              <span className="feature-dot purple" />
              <div className="feature-info">
                <span className="feature-title">Secure by design</span>
                <span className="feature-desc">JWT + BCrypt encryption</span>
              </div>
            </div>
            <div className="sidebar-feature">
              <span className="feature-dot yellow" />
              <div className="feature-info">
                <span className="feature-title">Instant setup</span>
                <span className="feature-desc">Start monitoring in seconds</span>
              </div>
            </div>
          </div>
        ...
        <div className="sidebar-bottom">
          <div className="sidebar-status">
            ...
            <span className="status-label">Ready for new connections</span>
          </div>
      ...
      <div className="auth-main">
        <div className="auth-card">
          <div className="auth-header">
            ...
            <p>Set up your monitoring workspace</p>
          </div>
